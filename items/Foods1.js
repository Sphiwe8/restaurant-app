...
export default function Foods1({navigation}) {
  ...
  const drinks = () => {
    ...
    const location = () => {
    navigation.navigate('Location',  {menu:"Breakfast Delight"});
  };
  
    const order = () => {
    navigation.navigate('Ordder');
  };
...
<Image style={styles.itemImage} source={require('../assets/foods1.png')}/>
       </View>
